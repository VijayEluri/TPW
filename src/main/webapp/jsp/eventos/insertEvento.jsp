...
<div class="divPadrao" style="width: 500px"><s:form theme="simple"
	...
	<table width="100%">
		...
		<tr>
			...
			<td colspan="3"><s:textfield name="evento.nome" maxlength="300" cssStyle="width: 300px" /></td>
		</tr>
		...
		<tr>
		 ...
		 <tr>
			...
			<td colspan="3">
				<s:date name="evento.data" id="data" format="dd/MM/yy"/>
				<s:textfield name="evento.data" /></td>
   		</tr>

		<tr>
			<td align="right"><span class="label" style="font-weight: bold">Responsavel:</span></td>
			<td colspan="3"><s:textfield name="evento.responsavel" maxlength="300" cssStyle="width: 300px" /></td>
		</tr>
